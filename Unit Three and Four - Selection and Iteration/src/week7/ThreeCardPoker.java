...
private static final double CARDS_PER_SUIT = 0;
...
public static void main(String[] args) {
    ...
    private static String discard(Scanner in, String playerHand) {
        ...
        // 0 - do nothing
        // 3 - get them 3 cards to replace their old cards
        // 1 and 2 => ask them the cards to replace
        // ex. if 1 card then user will type 6H if they do not have a 6H it will let them know
